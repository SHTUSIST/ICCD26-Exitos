...
First,
we leverage the   io\_uring~\cite{iouring,ioctlWik84:online} to asynchronously transfer extents for non-preallocated log files.
The io\_uring provides user-space asynchronous I/O interfaces,
while
