...
\begin{figure*}[htbp]
   ...
   \scalebox{0.9}{ \includegraphics[width=0.5\textwidth, page=1]{fig/eval/sysbench_ob/sysbench_ob_legend.pdf}}\\
    ...
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
           \scalebox{0.9}{       \includegraphics[width=\textwidth, page=1]{fig/eval/sysbench_ob/sysbench_ob_All_Insert_throughput2.pdf}}
                 \vspace{-1ex}
    ...
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
          \scalebox{0.9}{        \includegraphics[width=\textwidth, page=1]{fig/eval/sysbench_ob/sysbench_ob_All_Insert_latency2.pdf}}
                \vspace{-1ex}
